...
const HorizontalCard = ({ id, name, img, time, icon, timeicon, navigate }) => (
  <CardWrapper>
    {/* <ImgGroup> */}
    <img
      src={img}
...
const CardWrapper = tw.div`relative max-w-xs h-28 md:h-36 hover:scale-110 transform transition duration-200 hover:shadow-lg `;
...
const Overlay = tw.div`absolute left-0 bottom-0 right-0 top-50 w-full h-1/2 bg-gradient-to-t from-secondaryBg-blue to-transparent   opacity-90`;
