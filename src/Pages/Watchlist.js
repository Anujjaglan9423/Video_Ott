...
const Watchlist = () => {
  ...
  return (
    <Container>
      ...
      {/* <h1 className="text-white font-md text-2xl font-semibold  max-w-7xl md:mx-auto mt-8 mb-6 ml-2 mr-2"> */}
      <h1 className="text-white font-md text-2xl font-semibold   md:mx-auto mt-8 mb-6 ml-2 mr-2">
        Watchlist
      </h1>
      <CardContainer>
        {data.map((item) => (
...
const Container = tw.section`bg-secondaryBg-blue justify-between mx-auto  text-white  font-medium  px-4 mx-auto  sm:items-center  md:px-6   `;
...
const CardContainer = tw.div`grid  grid-cols-2 sm:grid-cols-3  md:grid-cols-5 gap-x-5 gap-y-8 xl:grid-cols-5 gap-5   md:mx-auto mt-4  ml-2 mr-2  `;
// const CardContainer = tw.div`grid  grid-cols-2 sm:grid-cols-3  md:grid-cols-5 gap-x-5 gap-y-8 xl:grid-cols-5 gap-5 max-w-7xl  md:mx-auto mt-4  ml-2 mr-2  `;
